...
from ..types import PromptInfo, ResourceInfo, ServerInfo, ToolInfo
...
class MCPClient:
    ...
    def __init__(self, connection: Connection):
        ...
        self._client_info = {"name": "lmcp", "version": "0.1.0"}
    ...
    async def get_resource(self, uri: str) -> Any:
        ...
        try:
            request = ReadResourceRequest(id=self._generate_id(), params={"uri": uri})
    ...
    async def get_prompt(self, name: str, arguments: Dict[str, Any]) -> Any:
        ...
        try:
            request = GetPromptRequest(
                id=self._generate_id(), params={"name": name, "arguments": arguments}
            )
