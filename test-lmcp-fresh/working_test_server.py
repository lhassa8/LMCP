...
@lmcp.server("working-test")
class WorkingtestServer:
...
if __name__ == "__main__":
    ...
    if sys.stdout.isatty():
        print("🚀 Starting working-test server...")
        print("📋 Available tools: add, sqrt, greet")
        print("📁 Available resources: server://info, server://stats")
        print('🌐 Use the LMCP CLI to test: lmcp client list-tools "stdio://python working_test_server.py"')
        print()
    
    server = WorkingtestServer()
