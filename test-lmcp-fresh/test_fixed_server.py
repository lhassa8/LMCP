...
if __name__ == "__main__":
    ...
    if sys.stdout.isatty():
        print("🚀 Starting test-fixed server...")
        print("📋 Available tools: add, sqrt, greet")
        print("📁 Available resources: server://info, server://stats")
        print("🌐 Use the LMCP CLI to test: lmcp client list-tools "stdio://python test_fixed_server.py"")
        print()
    
    server = TestfixedServer()
